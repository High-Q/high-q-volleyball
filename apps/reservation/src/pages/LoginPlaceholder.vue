...
<template>
  ...
  >
    <div class="flex w-full max-w-md flex-col gap-hq-6 px-hq-8 py-hq-14">
      <p
      ...
      <h1 class="font-jp-display text-2xl text-ink">ログイン — 準備中</h1>
      <p class="text-sm text-muted">
        この画面は予約サイトの会員ログインとして後続 Issue で本実装されます。
      </p>
      <div>
