...
describe("router auth guard", () => {
  ...
  it("AAL2 admin で / にアクセスすると通過する", async () => {
    session.status.value = "authenticated";
  ...
  it("AAL2 admin が /login にアクセスすると / にリダイレクトされる", async () => {
    session.status.value = "authenticated";
    session.aal.value = "aal2";
    session.isAdmin.value = true;
  ...
  it("AAL2 admin が /mfa にアクセスすると / にリダイレクトされる", async () => {
    session.status.value = "authenticated";
    session.aal.value = "aal2";
    session.isAdmin.value = true;
