...
関連 Issue: #92（reservation 側アップロード）/ #171（admin 側確認・承認）/ #193（プライバシーポリシー本文ページ）

関連文書:
- [docs/06-品質・セキュリティ/06-個人情報保護方針.md](./06-個人情報保護方針.md) — 個人情報保護法に基づく取扱方針 (内部運用版)
- LP `/privacy` ページ (`apps/lp/src/pages/privacy/`) — 同方針の公開版 (取得項目・利用目的・第三者提供・保管期間・安全管理・開示請求窓口を網羅)
