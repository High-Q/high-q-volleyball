    ...
    <div style={{ flex: 1, overflow: 'auto', padding: '24px 20px 28px' }}>
      ...
      <div style={{ marginTop: 24, display: 'flex', flexDirection: 'column', gap: 10 }}>
        <button style={{
          ...
          background: HQ.ink, color: HQ.paper, border: 'none', borderRadius: 999,
          fontFamily: HQ.jp, fontSize: 13.5, fontWeight: 500, cursor: 'pointer',
        }}>カレンダーに追加 (.ics)</button>
        <button style={{
          width: '100%', padding: '14px 0',
          background: 'transparent', color: HQ.ink,
      ...
      <div style={{ marginTop: 28, padding: '16px 18px', background: '#fbf8f1', border: `1px solid ${HQ.hairline}`, borderRadius: 10 }}>
        <RKicker color={HQ.muted}>— CANCEL POLICY</RKicker>
        <p style={{ margin: '8px 0 0', fontFamily: HQ.jp, fontSize: 11.5, color: HQ.inkSoft, lineHeight: 1.7 }}>
          開催 24 時間前まではキャンセル可能です。それ以降は満額のキャンセル料がかかります。
        </p>
      </div>

      <button style={{
        width: '100%', padding: '14px 0', marginTop: 18,
...
Object.assign(window, { ScreenRHistory, ScreenRReservation, ScreenRHomeV2 });
