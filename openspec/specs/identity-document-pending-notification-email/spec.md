# identity-document-pending-notification-email Specification

## Purpose
TBD - created by archiving change notify-identity-document-pending. Update Purpose after archive.
## Requirements
