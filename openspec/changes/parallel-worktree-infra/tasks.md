...
- [x] 5.1 `docs/03-アーキテクチャ/07-並列開発ガイド.md` を新規作成
- [x] 5.2 章立て: 概要 / worktree 配置 / ブランチ運用 / ポート規約 / dev DB / OpenSpec 衝突 / スクリプト使い方 / Skill 一覧 / トラブルシューティング
- [x] 5.3 `CLAUDE.md` Pillar 5 末尾に 1 行参照を追記
